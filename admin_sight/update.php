...
<?php require_once("./header.php"); ?>
    ...
    <main>
      <form action="update_chk.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="title" value=<?php (isset($_SESSION['title'])) ? print $_SESSION['title'] : print $val['title']; ?>>
        <p>記事</p>
        <textarea cols="80" rows="10" name="news"><?php (isset($_SESSION['news'])) ? print $_SESSION['news'] : print $val['news']; ?></textarea>
